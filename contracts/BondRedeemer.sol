...
contract BondRedeemer is Ownable {
    ...
    function getLatestPrice(address oracleAdd) public view returns (int) {
    ...
    function permitToken(address token, uint256 discountRate, address oracle) public onlyOwner {
